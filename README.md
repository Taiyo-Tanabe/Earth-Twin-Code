...
```
horizon = 現在年 − データ最新年 + 1
例: データ年 2024、今 2026 → shift(-3) → 2027年を予測
    表示: 2026/06/17 〜 2027/06/17（常に今日から1年後）
```

この+1により、モデルの予測年は常に「来年」を指し、画面の動的表示（今日→1年後）と一致する。毎年の自動再学習時にも同じ計算が適用される。
